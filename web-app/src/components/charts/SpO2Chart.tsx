          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative group">
              <select 
                ...
                className="appearance-none bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 text-xs font-semibold py-2 pl-3 pr-8 rounded-lg cursor-pointer focus:outline-none focus:ring-2 focus:ring-teal-100 transition-colors min-w-[120px]"
              >
