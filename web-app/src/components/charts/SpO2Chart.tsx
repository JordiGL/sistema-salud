    ...
    <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col relative overflow-hidden space-y-6">
      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-slate-500 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 hover:text-teal-600 transition-colors"
            title="Descargar CSV"
          >
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <div className="relative group">
              <select
                ...
                className="appearance-none bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 text-xs font-bold py-2 pl-3 pr-8 rounded-lg cursor-pointer focus:outline-none focus:ring-2 focus:ring-teal-100 transition-colors min-w-[100px]"
              >
      ...
      {finalData.length > 0 && (
        <div className="pt-6 border-t border-slate-100">
          ...
          <StatsSummary
            label={tCharts('spo2Title')} /* O "SpO2" */
            data={spo2Data}
